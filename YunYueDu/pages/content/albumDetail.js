(function () {
    ...
    WinJS.UI.Pages.define("/pages/content/albumDetail.html", {
...
//重置图片
            var eles = htmlContent.querySelectorAll("img");

            for (var i = 0, len = eles.length;i<len;i++){
                if (i % 3 === 0) {
                    eles[i].style.height = "700px";
                    eles[i].style.minWidth = "780px";
                } else {
                    eles[i].style.width = "780px";
                    eles[i].style.maxHeight = "350px";
                }
                

            }
            if (element.querySelectorAll("img")) {
                var imgObjects = element.querySelectorAll("img");
